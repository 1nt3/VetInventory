...
-- Insertar roles
INSERT INTO role (name, description) VALUES ('Administrador', 'Administrator role');
INSERT INTO role (name, description) VALUES ('Secretaria', 'Regular user role');
...
INSERT INTO supplier (name, address, phone, email) VALUES ('Sin proveedor', '', '', '');
...
INSERT INTO product (name, description, category_id, supplier_id, price_purchase, price_sell, stock_initial, stock_current, utility) VALUES ('Product 1', 'Product 1 description', 1, 1, 10.0, 15.0, 100, 100, 0.0);
INSERT INTO product (name, description, category_id, supplier_id, price_purchase, price_sell, stock_initial, stock_current, utility) VALUES ('Product 2', 'Product 2 description', 2, 2, 20.0, 25.0, 150, 150, 0.0);
